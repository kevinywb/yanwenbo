...
var config = {
  ...
  session_secret: 'yanwenbo_secret', // 务必修改
  auth_cookie_name: 'yanwenbo',
  ...
  // github 登陆的配置
  GITHUB_OAUTH: {
    clientID: 'fbd51d548e73f575768c',
    clientSecret: '8e6c7c55a417db95a196a57c11f0a4f3ab01dc44',
    callbackURL: 'http://yanwenbo.cn/auth/github/callback'
  },
...
if (process.env.NODE_ENV === 'test') {
  config.db = 'mongodb://127.0.0.1/yanwenbo';
}
